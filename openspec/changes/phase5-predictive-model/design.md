...
- **[Trade-off] Choosing CA-Markov as the "safe" baseline sacrifices some of the novelty a purely deep-learning predictive layer might have offered.** Accepted deliberately: the thesis's differentiator is auditable evaluation methodology, not maximal model sophistication (see `docs/METODOLOGIA_PIPELINE.md`, "6. Justificación de cada modelo").
